...
final class LocationRepositoryTest extends TestCase
{
    ...
    {
        self::assertTrue(
            is_subclass_of(LocationRepository::class, Repository::class),
            LocationRepository::class . ' must extend ' . Repository::class,
        );
    }
    ...
    {
        $reflection = new \ReflectionClass(LocationRepository::class);
